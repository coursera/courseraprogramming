...
========================================
We upgraded the infrastructure system for Coursera Programming
Assignment auto-graders. All newly uploaded custom graders
using web UI will use Autograder 2.0 infrastructure.
Thus, we encourage you to start use the new SDK,
coursera_autograder:
https://github.com/coursera/coursera_autograder .
Courseraprogramming will be sunsetted on January 13, 2021.
For more information about the Autograder 2.0 infrastructure,
please review this document:
https://docs.google.com/document/d/1pC6nvQbgVGoQ1LUoKKfxc-Hi4NkhhlnKKG_Wnydu5p8
========================================
""")
